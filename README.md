# JSweet express-body-parser candy

## Description

This project is a Java bridge to the express-body-parser library, so that express-body-parser can be used from Java (thanks to the JSweet transpiler).
